...
const newsData = [
    // 1. НАЙНОВІША (ГОЛОВНА) - 18 СЕРПНЯ
    {
        ...
        content: `
            ...
            <p>Менеджмент команди Outsiders спростував чутки про можливий перехід їхнього гравця. "<strong>NinetyEight залишається в Outsiders</strong>," - йдеться в офіційному прес-релізі.</p>
            <p>Але вже через 20 годин капітан команди Outsiders сказав: "@NinetyEight покинув команду Outsiders через те що не зміг показати хороший результат", а на його заміну прийшов @ChortizTabakerky</p>
